...
# Si existe la carpeta models, probamos models/weapon_detection/best_model.pth
model_default = REPO_ROOT / "models" / "weapon_detection" / "best_model.pth"
candidate_paths.append(str(model_default))
...
if not weapon_model_path:
    ...
    raise FileNotFoundError("No se encontró el modelo de armas. Configure WEAPON_MODEL_PATH o coloque models/weapon_detection/best_model.pth")
else:
